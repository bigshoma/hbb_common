...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("mitok-support".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.mitok.ru"];
pub const RS_PUB_KEY: &str = "btihOGgLo2LR3nM4mIB4kVgdYmSB0fg6Q3QMMR62TFE=";
